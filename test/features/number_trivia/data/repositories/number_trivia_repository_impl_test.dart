...
void main() {
  ...
  group("getConcreteNumberTrivia", () {
    ...
    test("should check if the device is online", () async {
      ...
      when(mockNetworkInfo.isConnected).thenAnswer((_) async => true);
      // act
      repository.getConcretNumberTrivia(tNumber);
      // assert
    ...
    runTestsOnline(() {
      ...
      test(
          ...
          () async {
        // arrange
        when(mockRemoteDataSource.getConcretNumberTrivia(any))
            .thenAnswer((_) async => tNumberTriviaModel);
        // act
        await repository.getConcretNumberTrivia(tNumber);
        // assert
        verify(mockRemoteDataSource.getConcretNumberTrivia(tNumber));
      ...
      test(
        ...
        // act
        final result = await repository.getConcretNumberTrivia(tNumber);
        // assert
        verify(mockRemoteDataSource.getConcretNumberTrivia(tNumber));
